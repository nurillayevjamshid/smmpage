...
export default function Topbar({ onMenuToggle }: TopbarProps) {
  return (
    <header className="h-16 lg:h-20 bg-white/90 backdrop-blur-md border-b border-slate-200 flex items-center justify-between px-4 sm:px-6 lg:px-8 sticky top-0 z-10 w-full transition-all shrink-0">
